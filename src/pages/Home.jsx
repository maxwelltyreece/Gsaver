...
const Home = () => {
	...
	return (
		<div className="mt-12">
			...
			<div className="flex mx-24 mt-4 gap-6 flex md:justify-center">
				...
				<div className="flex md:hidden grid w-full gap-6">
					<Paper
						className="flex rounded-3xl opacity-20 hover:opacity-40"
