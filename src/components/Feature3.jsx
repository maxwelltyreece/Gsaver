import chatbot from "../data/chatbotSS3.png"
			...
			<div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:py-40 lg:px-8">
				<div className="pr-6 pl-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
					...
					<p className="mt-6 text-base leading-7 text-gray-300">
						Our in house chat bot allows you to sort iron out all your worries
						and compplaints, however we have our contact us page if you need
						help from real world professionals
					</p>
					<div className="mt-8">
						<a
							href="#"
